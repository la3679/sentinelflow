...
# reaching the dead-letter path - and neither exists to replay until the scoring
# client does. It lands with the pieces it demonstrates rather than ahead of
# them. The data shapes it would replay are already generated by `make seed`.
replay: ## (Phase 4, in progress) Replay the default synthetic scenario
	@echo "make replay is not implemented yet."
	@echo "The transaction shapes it replays are generated today by 'make seed'."
	@echo "Replay itself lands with the scoring client, whose outage and poison-event"
	@echo "scenarios are the ones worth replaying. See docs/planning/IMPLEMENTATION_PLAN.md."
	@exit 1
